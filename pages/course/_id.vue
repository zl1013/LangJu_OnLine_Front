  ...
  <div id="aCoursesList" class="bg-fa of">
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="courseWebVo.cover" height="357px" :alt="courseWebVo.title" class="dis c-v-pic">
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg" v-if="courseWebVo.price > 0">
            ...
            <section class="c-attr-mt">
              <a href="#" v-if="isPay || Number(courseWebVo.price) === 0" title="立即观看" class="comm-btn c-btn-3">立即观看</a>
              <a href="#" v-else title="立即购买" class="comm-btn c-btn-3" @click="createOrder()">立即购买</a>
            </section>
          </section>
        </aside>
    ...
    <div class="mt50 commentHtml"><div>
      ...
      <section class="">
        ...
        <!-- 公共分页 开始 -->
        <div class="paging" v-if="data.total">
